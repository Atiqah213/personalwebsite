            ...
            <div class="superb-addons-template-library-page-content-inner-menu">
                <div class="superb-addons-template-library-page-content-inner-menu-left">
                    <div id="superb-addons-template-library-page-search-wrapper">
                        ...
                        <input id="superb-addons-template-library-page-search-input" type="text" placeholder="<?php echo esc_attr__('Search', "superb-blocks"); ?>" />
                    </div>
                </div>
            ...
            <div class="superb-addons-template-library-preview-modal-content">
                <div class="superb-addons-template-library-preview-top">
                    <div class="superb-addons-template-library-preview-left">
                        <p><?php echo esc_html__('This preview is an image.', "superb-blocks"); ?> <span clsas="superb-addons-template-library-preview-left-livepreview-explain" style="display:none;"><?php echo esc_html__('To see the element live, click the "Live Preview" button.', "superb-blocks"); ?></span></p>
