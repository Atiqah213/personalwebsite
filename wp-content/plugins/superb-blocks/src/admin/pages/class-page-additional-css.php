...
?>
        <div class="superbaddons-admindashboard-content-box-large superbaddons-admindashboard-css-blocks">
            <h3 class="superbaddons-element-text-md superbaddons-element-text-800 superbaddons-element-m0 superbaddons-element-mb1 superbaddons-element-text-dark"><?php echo esc_html($edit_or_create); ?><small class="superbaddons-element-ml1 superbaddons-element-text-xs superbaddons-element-text-gray"><?php echo esc_html(($this->IsCreating || ($this->CurrentCssBlock && $this->CurrentCssBlock->active) ? "" : __("This CSS block is currently deactivated.", "superb-blocks"))); ?></small></h3>
            ...
            <div class="superbaddons-css-block-input-options superbaddons-element-mt1 superbaddons-element-mb2">
                <label for="superbaddons-css-block-name-input" class="superbaddons-element-text-xs superbaddons-element-text-800 superbaddons-element-m0 superbaddons-element-mb1 superbaddons-element-flex-center"><img width="15" class="superbaddons-element-ml1 superbaddons-element-mr1" src="<?php echo esc_url(SUPERBADDONS_ASSETS_PATH . '/img/purple-file.svg'); ?>" /><?php echo esc_html__("CSS Block Name", "superb-blocks"); ?></label>
                <input type="text" id="superbaddons-css-block-name-input" class="superbaddons-element-input superbaddons-element-mb2" placeholder="<?php echo esc_attr__("My CSS Block", "superb-blocks"); ?>" value="<?php echo $this->CurrentCssBlock ? esc_attr($this->CurrentCssBlock->name) : ""; ?>" maxlength="<?php echo esc_attr(CSSController::BLOCK_NAME_MAX_LENGTH); ?>" />

                <div class="superbaddons-css-block-target-inputs-wrapper superbaddons-element-mt1">
                    <label class="superbaddons-element-text-xs superbaddons-element-text-800 superbaddons-element-m0 superbaddons-element-mb1 superbaddons-element-flex-center"><img width="25" class="superbaddons-element-mr1" src="<?php echo esc_url(SUPERBADDONS_ASSETS_PATH . '/img/target-duotone.svg'); ?>" /><?php echo esc_html__("Target", "superb-blocks"); ?></label>
            ...
            <div class="superbaddons-css-block-css-input-wrapper-outer">
                <div class="superbaddons-css-block-css-input-wrapper superbaddons-element-mt1">
                    <label for="superbaddons-css-block-css-input" class="superbaddons-element-text-xs superbaddons-element-text-800 superbaddons-element-m0 superbaddons-element-mb1 superbaddons-element-flex-center"><img width="25" class="superbaddons-element-mr1" src="<?php echo esc_url(SUPERBADDONS_ASSETS_PATH . '/img/purple-paint-brush.svg'); ?>" /><?php echo esc_html__("CSS", "superb-blocks"); ?></label>
                    <textarea id="superbaddons-css-block-css-input" class="superbaddons-element-textarea superbaddons-element-mb1" rows="10"><?php echo $this->CurrentCssBlock ? esc_html($this->CurrentCssBlock->css) : ""; ?></textarea>
            ...
            <div class="superbaddons-css-block-save-options">
                <button type="button" class="superbaddons-css-block-save-btn superbaddons-element-button superbaddons-element-m0">
                    <img class="superbaddons-element-button-icon" src="<?php echo esc_url(SUPERBADDONS_ASSETS_PATH . '/img/floppy-disk-duotone.svg'); ?>" />
                ...
                <div class="superbaddons-element-mla superbaddons-element-flex-center">
                    <span class="superbaddons-vertical-separator"></span>
                    <div class="superbaddons-created-css-block-options" <?php echo $this->IsCreating ? 'style="display:none;"' : '' ?>>
                    ...
                    <a href="<?php echo esc_url(admin_url("admin.php?page=" . DashboardController::ADDITIONAL_CSS)); ?>" class="superbaddons-css-block-cancel-btn superbaddons-element-button superbaddons-element-m0">
                        <img class="superbaddons-element-button-icon" src="<?php echo esc_url(SUPERBADDONS_ASSETS_PATH . '/img/backspace.svg'); ?>" />
                        <?php echo esc_html__("Cancel", "superb-blocks"); ?>
                    </a>
                </div>
        ...
        <?php if ($this->CurrentCssBlock) : ?>
            <script>
                const superbaddons_init_css_block_selectors = <?php echo wp_json_encode($this->CurrentCssBlock->selectors); ?>;
                const superbaddons_init_css_block_id = <?php echo wp_json_encode($this->CurrentCssBlock->id); ?>;
            </script>
        <?php endif; ?>
    <?php
    }
            ...
            <div class="superbaddons-css-block-live-preview-container">
                <div class="superbaddons-css-live-preview-menu">
                    ...
                    <button id="superbaddons-preview-reload-button" type="button" class="superbaddons-element-button superbaddons-element-button-small superbaddons-element-m0">
                        ...
                        <?php echo esc_html__("Reload Preview", "superb-blocks"); ?>
                    </button>
                ...
                <div class="superbaddons-css-block-live-preview-content">
                    <div class="superbaddons-css-block-preview-input">
                        <div style="padding: 0 20px;">
                            <p class="superbaddons-element-text-xxs superbaddons-element-text-gray"><?php echo esc_html__("While editing, your CSS changes are only visible inside this live preview.", "superb-blocks"); ?></p>
                            <p class="superbaddons-element-text-xxs superbaddons-element-text-gray"><?php echo esc_html__("Your selected CSS Block targets are not active inside the live preview and your CSS will be previewed on every page and post.", "superb-blocks"); ?></p>
                            <?php if (!$this->IsCreating) : ?>
                                <p class="superbaddons-element-text-gray" style="font-style:italic;font-size:12px;"><?php echo esc_html__("Do note that the currently saved CSS from this block will be applied during preview, even if the CSS is changed or removed in the preview editor.", "superb-blocks"); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <div class="superbaddons-admindashboard-sidebarlayout">
            <div class="superbaddons-admindashboard-sidebarlayout-left">
                <div class="superbaddons-additional-content-wrapper superbaddons-admindashboard-css-blocks">
                    <h3 class="superbaddons-element-text-md superbaddons-element-text-800 superbaddons-element-m0 superbaddons-element-mb1 superbaddons-element-text-dark"><?php echo esc_html__("Custom CSS Blocks", "superb-blocks"); ?></h3>
                    <p class="superbaddons-element-text-gray superbaddons-element-text-400 superbaddons-element-m0 superbaddons-element-mb1"><?php echo esc_html__("Optimize your design and website with CSS blocks by deciding exactly when and where on your website you wish the CSS to be loaded. CSS files will automatically be generated, optimized and loaded to match your settings.", "superb-blocks"); ?></p>
                    <p class="superbaddons-element-text-gray superbaddons-element-text-400 superbaddons-element-m0 superbaddons-element-mb1"><?php echo esc_html__("Create a new CSS block, import, export or select one you wish to edit.", "superb-blocks"); ?></p>
                    <div class="superbaddons-css-block-base-options">
                        <a href="<?php echo esc_url(admin_url("admin.php?page=" . DashboardController::ADDITIONAL_CSS . '&css-create')); ?>" class="superbaddons-element-button superbaddons-element-mt1">
                            <img class="superbaddons-element-button-icon" src="<?php echo esc_url(SUPERBADDONS_ASSETS_PATH . '/img/purple-files.svg'); ?>" />
                            <?php echo esc_html__("Create New CSS Block", "superb-blocks"); ?>
                        </a>
                        <span class="superbaddons-vertical-separator"></span>
                    ...
                    <h4 class="superbaddons-element-text-sm superbaddons-element-text-800 superbaddons-element-m0 superbaddons-element-mt1 superbaddons-element-text-dark"><?php echo esc_html__("CSS Blocks", "superb-blocks"); ?></h4>

                    <hr class="superbaddons-element-mb1" />

                    <div class="superbaddons-css-blocks-list">
                        <?php if (empty($this->Blocks)) : ?>
                            <p class="superbaddons-element-text-gray superbaddons-element-text-400 superbaddons-element-m0 superbaddons-element-mb1"><?php echo esc_html__("You do not have any CSS Blocks yet. Import or create a new CSS Block to get started.", "superb-blocks"); ?></p>
                        <?php endif; ?>
                        <?php foreach ($this->Blocks as $block_id => $block) : ?>
                            <a href="<?php echo esc_url(admin_url("admin.php?page=" . DashboardController::ADDITIONAL_CSS . '&css-edit=' . $block_id)); ?>" data-id="<?php echo esc_attr($block_id); ?>" class="superbaddons-element-button superbaddons-element-m0 superbaddons-element-mb1 superbaddons-css-block-item <?php echo $block->active ? "" : "superbaddons-css-block-item-deactivated"; ?>">
                                ...
                                <div class="superbaddons-css-block-item-information">
                                    <div class="superbaddons-css-block-title-wrapper">
                                        <img class="superbaddons-element-button-icon" src="<?php echo esc_url(SUPERBADDONS_ASSETS_PATH . ($block->active ? '/img/purple-file.svg' : '/img/x.svg')); ?>" />
                                        <span><?php echo esc_html($block->name); ?></span>
                                        <span class="superbaddons-element-ml1 superbaddons-element-text-gray"><?php echo $block->active ? "" : esc_html__("Deactivated", "superb-blocks"); ?></span>
                                    </div>
                                    <span class="superbaddons-element-text-gray"><?php echo esc_html($this->GetTargetLabels($block)); ?></span>
                                </div>
                    ...
                    <?php if (!empty($this->Blocks)) : ?>
                        <div class="superbaddons-css-blocks-list-options superbaddons-element-flex-center">
                            ...
                            <img class="superbaddons-element-button-icon superbaddons-element-mr1" src="<?php echo esc_url(SUPERBADDONS_ASSETS_PATH . '/img/arrow-elbow-left-up.svg'); ?>" />
